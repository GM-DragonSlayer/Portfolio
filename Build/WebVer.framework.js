...
var ASM_CONSTS = {
  4424156: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4424211: ($0) => { performance.now = function() { return $0; }; },  
 4424259: ($0) => { performance.now = function() { return $0; }; },  
 4424307: () => { performance.now = Module['emscripten_get_now_backup']; }
};
